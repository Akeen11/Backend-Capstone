...
namespace BackendCapstone.Controllers
{
    public class TreatmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TreatmentId,Name,Description,Price")] Treatment treatment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TreatmentId,Name,Description,Price")] Treatment treatment)
        {
